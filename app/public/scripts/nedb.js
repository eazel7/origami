        ...
        6: [
            function (require, module, exports) {
                ...
                function Datastore(options) {
                    ...
                    if (this.inMemoryOnly || this.persistence.inBrowser) {
                ...
                Datastore.prototype._insertMultipleDocsInCache = function (newDocs) {
                    var i, failingI, error, preparedDocs = this.prepareDocumentForInsertion(newDocs);
                ...
                Datastore.prototype._update = function (query, updateQuery, options, cb) {
                    ...
                    async.waterfall([
                        ...
                        function () { // Perform the update
                            var modifiedDoc, candidates = self.getCandidates(query),
                                modifications = [];
            ...
            function (require, module, exports) {
                ...
                function Executor() {
                    ...
                    this.queue = async.queue(function (task, cb) {
                        var callback, lastArg = task.arguments[task.arguments.length - 1],
                            i, newArguments = [];

                        // task.arguments is an array-like object on which adding a new field doesn't work, so we transform it into a real array
                        for (i = 0; i < task.arguments.length; i += 1) {
        ...
        9: [
            function (require, module, exports) {
                ...
                function areThingsEqual(a, b) {
                    ...
                    if (util.isArray(a) || util.isArray(b) || a === undefined || b === undefined) {
                        return false;
                    }
                ...
                comparisonFunctions.$size = function (obj, value) {
                    ...
                    if (value % 1 !== 0) {
                        throw "$size operator called without an integer";
                    }
                ...
                logicalOperators.$where = function (obj, fn) {
                    ...
                    if (!_.isFunction(fn)) {
                        throw "$where operator used without a function";
                    }

                    result = fn.call(obj);
                    if (!_.isBoolean(result)) {
                        throw "$where function must return boolean";
                    }
            ...
            function (require, module, exports) {
                ...
                _AVLTree.prototype.checkHeightCorrect = function () {
                    ...
                    if (this.left && this.left.height === undefined) {
                        throw "Undefined height for node " + this.left.key;
                    }
                    if (this.right && this.right.height === undefined) {
                        throw "Undefined height for node " + this.right.key;
                    }
                    if (this.height === undefined) {
                        throw "Undefined height for node " + this.key;
                    }
                    ...
                    if (this.height !== 1 + Math.max(leftH, rightH)) {
                        throw "Height constraint failed for node " + this.key;
                    }
                    if (this.left) {
                ...
                _AVLTree.prototype.checkBalanceFactors = function () {
                    if (Math.abs(this.balanceFactor()) > 1) {
                        throw 'Tree is unbalanced at node ' + this.key;
                    }
        ...
        14: [
            function (require, module, exports) {
                ...
                BinarySearchTree.prototype.checkInternalPointers = function () {
                    if (this.left) {
                        if (this.left.parent !== this) {
                            throw 'Parent pointer broken for key ' + this.key;
                        }
                ...
                BinarySearchTree.prototype.checkIsBST = function () {
                    ...
                    if (this.parent) {
                        throw "The root shouldn't have a parent";
                    }
                };
